...
function add_css(target) {
  append_styles(target, "svelte-1j4z0uo", "input.svelte-1j4z0uo{max-height:25px;overflow-x:auto}.modal-input-container.svelte-1j4z0uo{width:100%;display:flex;flex-direction:row;justify-content:flex-end;align-items:center;gap:10px;margin-top:10px}select.svelte-1j4z0uo{height:21px}");
}
...
function create_fragment(ctx) {
  ...
  return {
    c() {
      ...
      attr(select, "class", "flex-obj svelte-1j4z0uo");
      if (
        /*inputType*/
        ctx[4] === void 0
      )
      ...
      attr(input0, "class", "name-input flex-obj svelte-1j4z0uo");
      ...
      attr(input1, "class", "value-input flex-obj svelte-1j4z0uo");
      attr(div, "class", "modal-input-container svelte-1j4z0uo");
    },
    m(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  const click_handler = () => removeInput(id);
  ...
  $$self.$$set = ($$props2) => {
    if ("isNew" in $$props2)
      $$invalidate(1, isNew = $$props2.isNew);
...
function add_css2(target) {
  append_styles(target, "svelte-15r30to", ".modal-inputs-container.svelte-15r30to{height:200px;width:100%;overflow-y:scroll;border-radius:5px;border-style:solid}");
}
...
function create_fragment2(ctx) {
  ...
  return {
    c() {
      ...
      attr(div0, "class", "modal-inputs-container svelte-15r30to");
      attr(a, "class", "a-btn");
      attr(a, "href", "href");
      attr(div1, "class", "modal-add-container");
...
function instance2($$self, $$props, $$invalidate) {
  ...
  let countInputs = 1;
  let formEl;
  let inputEls = [{ id: 1, isNew: false, nameDef: "" }];
  function addInput() {
    countInputs++;
    const newInput = {
      id: countInputs,
